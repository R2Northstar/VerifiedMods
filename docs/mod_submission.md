...
We recommend you host your mod on [ModWorkshop](https://modworkshop.net/g/titanfall-2).

You can also host it on Thunderstore, in which case using [AnActualEmerald's mod template](https://github.com/GreenTF/NSModTemplate) would probably help.
